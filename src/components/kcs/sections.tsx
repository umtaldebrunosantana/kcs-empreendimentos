  ...
  return (
    <header className="relative isolate overflow-hidden bg-navy-900 text-white">
      <img
        ...
        width={1920}
        height={1080}
        className="absolute inset-0 -z-10 size-full object-cover object-[30%_center] opacity-45"
      />
      <div className="absolute inset-0 -z-10 bg-gradient-to-r from-navy-950/95 via-navy-900/80 to-navy-900/55" />
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-navy-950/70 via-navy-900/40 to-navy-900/85" />
